...
class fractal_octahedron
{
  public:
    ...
    unsigned int node_cardinal() const { return gfg::point::number_at_stage(m_rank); }
    unsigned int face_cardinal() const { return gfg::face::number_at_stage(m_rank); }
    unsigned int edge_cardinal() const { return gfg::edge::number_at_stage(m_rank); }
